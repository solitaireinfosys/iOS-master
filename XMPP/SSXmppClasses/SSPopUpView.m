    ...
    // set top images
    {
        ...
        // left image
        {
            ...
            //Set internal View
            {
                ...
                UIImageView *leftimage = [[UIImageView alloc]init];
                NSURL *imageURL = [NSURL URLWithString:imageFirst];
                if (imageURL) {
                }
        ...
        //Right image
        {
            ...
            
            {
                CGFloat width = (window.frame.size.width)-95;
                UIImageView *rightimage = [[UIImageView alloc]init];
                NSURL *imageURL = [NSURL URLWithString:imageSecond];
                if (imageURL) {
                }
    ...
    // set bottom buttons
    {
        ...
        [self addConstraints:
         @[
           ...
           [NSLayoutConstraint constraintWithItem:bottomView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeTop multiplier:1.0 constant:(((window.frame.size.height)/2)+40)],
           ]];
        ...
        // top button
        {
            ...
            [buttonChat setTitle:@"Send a message" forState:UIControlStateNormal];
        ...
        // bottom button
        {
            ...
            [buttonSearch setTitle:@"Keep browsing" forState:UIControlStateNormal];
            [buttonSearch setImage:[UIImage imageNamed:@"PopupSearch"] forState:UIControlStateNormal];
